 ...
 */
public class MainNavigator extends FrameLayout implements IPagerNavigator, MainNavigatorHelper.OnNavigatorScrollListener {
    ...
    private MainNavigatorHelper mNavigatorHelper;
    ...
    public MainNavigator(Context context) {
        super(context);
        mNavigatorHelper = new MainNavigatorHelper();
